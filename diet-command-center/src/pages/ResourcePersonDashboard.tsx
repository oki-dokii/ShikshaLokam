...
export default function ResourcePersonDashboard() {
    ...
    const triggerDownload = (fileName: string, content: string, title: string) => {
        ...
        doc.text('SHIKSHALOKAM DIET COMMAND CENTER', 20, 20);
        ...
        doc.text('Generated by DIET Intelligence Engine v2.0 - Strictly Confidential', 20, 280);
        ...
        toast.promise(
            new Promise((resolve) => setTimeout(resolve, 2500)),
            {
                ...
                success: () => {
                    ...
                    Pedagogical observations indicate a shift towards experiential learning across the cluster, though specific gaps remain in language proficiency modules. All data is synchronized with the DIET Central Repository.`;
